...
const Portfolio = () => {
  const projects = [
    {
      title: '创意电商平台',
      description: '一个具有独特视觉设计的现代电商网站，采用React和Tailwind CSS构建',
    ...
    {
      title: '数据可视化仪表盘',
      description: '实时数据监控仪表盘，支持多种图表类型和自定义主题',
    ...
    {
      title: '3D 产品展示',
      description: '使用Three.js创建的交互式3D产品展示页面',
    ...
    {
      title: '社交媒体应用',
      description: '功能完整的社交平台，支持实时消息和图片分享',
    ...
    {
      title: '个人博客系统',
      description: '支持Markdown编辑和代码高亮的现代化博客平台',
